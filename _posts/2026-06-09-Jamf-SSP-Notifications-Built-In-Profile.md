---
title: "Don't ignore me!: Self Service+ notifications are now managed on _all_ devices."
date: 2026-06-09 11:00:00 +0100
description: "Notifications for Jamf's Self Service+ application were only managed for devices enrolled after Jamf Pro 11.18, or via a custom profile. Jamf Pro's 11.28.X version fixes this across your fleet"
...
Hidden within the Jamf Pro 11.28 [release notes](https://learn.jamf.com/r/en-US/jamf-pro-release-notes-current/Resolved_Issues) there's a small entry that is really helpful to admins:
...
However, this change only was realised on *new* enrolments into the Jamf Pro server after it was upgraded.<br>
...
Looking at the content of the profile, this is what is contains:
...
![Image showing the computer record management history tab in Jamf Pro, searching for 'notifications'](/assets/img/postImages/2026-06-09/3-Queued-up%20computer-command.png)
...
![Image of terminal showing the contents of the updated profile in XML structure](/assets/img/postImages/2026-06-09/4-Updated-profile-contents-terminal.png)

<details>

<summary>XML contents in text can be viewed here</summary>
